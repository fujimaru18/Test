...
public class SupplierView extends JPanel {
    ...
    private void btnSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnSearchMouseClicked
        ...
        for (Supplier s : list) {
            model.addRow(new Object[]{
                s.getsupplierId(), s.getName(), s.getPhone_number(), s.getAddress(), s.getEmail()
            });
        }
    ...
    public void loadSuppliersToTable() {
        ...
        model.setRowCount(0);
        for (Supplier s : list) {
            model.addRow(new Object[]{s.getsupplierId(), s.getName(), s.getPhone_number(), s.getAddress(), s.getEmail()});
        }
    }
