...
public class OrderView extends javax.swing.JPanel {
     ...
     */
    private JComboBox<DanhMuc> comboBoxProduct;
    private int orderId;
...
//        cbproduct();
    ...
    public void loadData(int orderId) {
        this.orderId = orderId;
        // Tải lại dữ liệu đơn hàng theo orderId
        if (orderId <=0) {
           btnUpdateOrder.setEnabled(false);
        }  
        else{
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                        .addGap(71, 71, 71)
                                        .addComponent(lbid, javax.swing.GroupLayout.PREFERRED_SIZE, 0, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(40, 40, 40)
                                .addComponent(btnAdd)
                                .addGap(18, 18, 18)
    ...
    private void cbCategoriesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbCategoriesActionPerformed
        ...
        DanhMuc selectedCate = (DanhMuc) cbCategories.getSelectedItem();
    ...
    public void loadProductsByCategory(int categoryId) {
        ...
        List<SanPham> products = productDAO.getByCategoryId(categoryId);
...
//    }
    public void setCbCate() {
        DanhMucDAO catDAO = new DanhMucDAO();
        List<DanhMuc> catList = catDAO.getAll();

        cbCategories.removeAllItems();
        for (DanhMuc cate : catList) {
            cbCategories.addItem(cate);
        }
    }

    public SanPham getSelectedProduct() {
        return (SanPham) cbProducts.getSelectedItem();
    }
